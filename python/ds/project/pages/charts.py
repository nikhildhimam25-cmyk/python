...
char=px.scatter(data_frame=df, x="Commodity Group", y='MSP (Rs./Quintal) 2026-27', color="Commodity",title="𝗣𝗥𝗜𝗖𝗘𝗦 𝗢𝗙 𝗗𝗜𝗙𝗙𝗘𝗥𝗘𝗡𝗧 𝗖𝗢𝗠𝗠𝗢𝗗𝗜𝗧𝗜𝗘𝗦 𝗙𝗢𝗥𝗘𝗖𝗔𝗦𝗧 𝗙𝗢𝗥 2026–2027")
st.plotly_chart(char)


# char1=px.bar_polar(df,r="Arrival on 01 Jan, 2026",theta="Commodity Group",color="Commodity Group")
# st.plotly_chart(char1)

char2=px.scatter_3d(df,x="Arrival on 03 Jan, 2026",y="Arrival on 02 Jan, 2026",z="Arrival on 01 Jan, 2026",color="Commodity")
st.plotly_chart(char2)

char3=px.bar(df,x="Arrival on 03 Jan, 2026",y="Arrival on 01 Jan, 2026")
